...
- **Global (User):** `~/.gemini/agents/` (Personal subagents available across all workspaces).
...
1. **Create the file:** Create `.gemini/agents/<name>.md` (or `~/.gemini/agents/<name>.md` if global).
