...
3. **Authentication:** If you encounter an Auth Error, the user may need to authenticate using `gws auth login` or set appropriate environment variables like `GOOGLE_WORKSPACE_CLI_TOKEN`.
