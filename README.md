...
- **Agent Skills** — A library of 51 reusable [Agent Skills](https://agentskills.io) in [`skills/`](skills/), shared by every AI CLI above. They encode one canonical way to move from founder discovery through specifications, planning, implementation, review, QA, prompt design and agent evaluation, production readiness, launch, and learning, alongside language stacks, CI/CD, containers, infrastructure, docs, diagrams, releases, repository history, and security scanning.
